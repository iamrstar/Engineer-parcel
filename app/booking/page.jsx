...
deliveryLandmark: "",
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      paymentMethod: "COD",
      packageDetails: {
        weight: formData.parcelWeight === "under1" ? 1 : formData.parcelWeight === "1to5" ? 5 : formData.parcelWeight === "5to10" ? 10 : formData.parcelWeight === "10to20" ? 20 : 25,
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-sm text-muted-foreground">Document & parcel delivery</p>
                            </div>
                          </Label>
                        </div>
                        <div>
                          <RadioGroupItem value="shifting" id="shifting" className="peer sr-only" />
                          <Label
                            htmlFor="shifting"
                            className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-orange-600 [&:has([data-state=checked])]:border-orange-600"
                          >
                            ...
                            <div className="text-center">
                              <span className="font-semibold">Shifting & Moving</span>
                              <p className="text-sm text-muted-foreground">Home & office relocation</p>
                            </div>
                          </Label>
                        </div>
                        <div>
                          ...
                          >
                            ...
                            <div className="text-center">
                              <span className="font-semibold">Local Parcel</span>
...
<div>
  ...
  />
                    ...
                    {(formData.serviceType === "courier" ||
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor="parcelWeight">Parcel Weight (approx.)</Label>
                          <Select onValueChange={(value) => handleSelectChange("parcelWeight", value)}>
                            <SelectTrigger>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="above20">Above 20 kg</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        <div>
